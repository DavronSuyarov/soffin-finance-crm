...
// ============================================================
const mijozlar = rawMijozlar.map(mappers_js_1.mapRowToMijoz);
const hodimlar = rawHodimlar.map(mappers_js_1.mapRowToHodim);
const kirimlar = rawKirimlar.map(mappers_js_1.mapRowToKirim);
const chiqimlar = rawChiqimlar.map(mappers_js_1.mapRowToChiqim);
const maoshlar = rawMaoshlar.map(mappers_js_1.mapRowToMaosh);
// ============================================================
// HISOB-KITOB VA TAHLIL
// ============================================================
const summary = (0, finance_js_1.calculateDashboardSummary)(mijozlar, hodimlar, kirimlar, chiqimlar, maoshlar);
// ============================================================
...
console.log('====================================================');
console.log(`Mijozlar:     Jami: ${summary.jamiMijozlar} ta | Faol: ${summary.faolMijozlar} ta`);
console.log(`Hodimlar:     Jami: ${summary.jamiHodimlar} ta | Faol: ${summary.faolHodimlar} ta`);
console.log('----------------------------------------------------');
...
console.log('----------------------------------------------------');
console.log(`SOF FOYDA:               ${fmt(summary.sofFoyda)} UZS ${summary.sofFoyda >= 0 ? '📈' : '📉'}`);
console.log('----------------------------------------------------');
...
summary.oylikTahlil.forEach(m => {
    console.log(`  [${m.davr}] Kirim: ${fmt(m.kirim)} | Chiqim: ${fmt(m.jamiChiqim)} | Foyda: ${fmt(m.sofFoyda)}`);
});
console.log('====================================================');
